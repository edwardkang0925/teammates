  ...
  search(): void {
    ...
    forkJoin(
        ...
        .subscribe((resp: [InstructorSearchResult, InstructorSearchResult]) => {
          ...
          const searchStudentsListRowTable: SearchStudentsListRowTable[] = resp[1].searchStudentsListRowTables;
          const hasStudents: boolean = !!(
              searchStudentsListRowTable && searchStudentsListRowTable.length
          );
          ...
          if (hasStudents) {
            this.studentsListRowTables = searchStudentsListRowTable;
          }
